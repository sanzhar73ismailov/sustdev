...
$result = mysql_query ("UPDATE modules SET title='$title', meta_d='$meta_d', meta_k='$meta_k', text='$text' WHERE id='$id'");

if ($result == 'true') {echo "<p>Ваш модуль успешно обновлен!</p>";}
else {echo "<p>Ваш модуль не обновлен!</p>";}
