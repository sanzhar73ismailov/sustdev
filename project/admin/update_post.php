...
$result = mysql_query ("UPDATE lessons SET title='$title', meta_d='$meta_d', meta_k='$meta_k', date='$date', description='$description', text='$text', author='$author', module='$cat', mini_img='$img' WHERE id='$id'");

if ($result == 'true') {echo "<p>Ваш урок успешно обновлен!</p>";}
else {echo "<p>Ваш урок не обновлен! Ошибка:".mysql_error()."</p>";}
...
{
echo "<p>Вы ввели не всю информацию, поэтом урок в базе не может быть обновлен.</p>".mysql_error();
}
