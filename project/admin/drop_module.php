...
$result0 = mysql_query ("SELECT id FROM lessons WHERE module='$id'",$db);
if (mysql_num_rows($result0) > 0) {

echo "<p>В модуле, который Вы хотите удалить, есть уроки. Сначала перекиньте их по другим модулям.</p>";
...
{
$result = mysql_query ("DELETE FROM modules WHERE id='$id'");

if ($result == 'true') {echo "<p>Ваш модуль успешно удален!</p>";}
else {echo "<p>Ваш модуль не удален!</p>";}
