        ...
        <table width="690" border="1" align="center" bgcolor="#FFFFFF" class="main_border">
            ...
            <tr>
                <td valign="top"><table width="100%" border="1">
                        <tr>
                              <?php include("blocks/lefttd_lesson.php"); ?>
                            <td  valign="top">
                                 <?php $n=3; include("blocks/nav.php"); ?>
                              <?php echo $myrow["text"]; ?>
                            <?php
			$result1=mysql_query("select id, title, description, date FROM  lessons",$db);
			$myrow1=mysql_fetch_array($result1);
do{
// echo $myrow1["title"];
	printf ("<table class='lesson' align='center' width='500'>
			...
			</table><br><br>", $myrow1["id"], $myrow1["title"], $myrow1["date"], $myrow1["description"]);
