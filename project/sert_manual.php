...
$user_login='lineiceva_anastasia';

////////////////3 Вставляем имя и фамилию пользователя
$username="Линейцева Анастасия";
...
//$modulenames = return_arr_all_modules($_SESSION['user_id'], $mod_man);
$modulenames = return_arr_all_modules(163, $mod_man);
