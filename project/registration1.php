...
<html xmlns="http://www.w3.org/1999/xhtml">
                                ...
                                <form name="form_registr" action="registrationCheck.php" method="POST" onsubmit="return checkForm(this);">
                                    <table border="0" width="100%" cellspacing="1" cellpadding="5">
                                         <tbody>
                                            <tr>
                                                <td >Фамилия</td>
                                              <td  align=right><b class="regZvesd">*</b>&nbsp;</td><td><input type="text" name="userSurname" value="Санжар Тестирование" size="20" maxlength="30"/></td>
                                            </tr>
                                            <tr>
                                                <td>Имя</td>
                                                <td  align=right><b class="regZvesd">*</b>&nbsp;</td><td><input type="text" name="userName" value="имя СанжарТестирование" size="20"  maxlength="20"/></td>
                                            </tr>
                                            <tr>
                                                <td>Отчество</td>
                                                <td  align=right><b class="regZvesd">&nbsp;</b>&nbsp;</td><td><input type="text" name="userPatronicName" value="мое отчество" size="20"   maxlength="30"/></td>
                                            </tr>
                                            <tr>
                                                <td>Ваш пол</td>
                                                <td  align=right><b class="regZvesd">*</b>&nbsp;</td>
                                                <td><span><input id="field_gender_1" value="1" type="radio" name="sex" onchange="sex.value=1;" checked="checked">
                                                            ...
                                                            <input id="field_gender_2" value="0" type="radio" name="sex"  onchange="sex.value=0;">
                                                                ...
                                                                <tr>
                                                                    <td>Город (область)</td>
                                                                    <td  align=right><b class="regZvesd">*</b>&nbsp;</td><td><input type="text" name="city" value="Алматы" size="20"    maxlength="30"/></td>
                                                                </tr>
  ...
  <tr  valign="top">
                                                      ...
                                                      <td  align=right><b class="regZvesd">*</b>&nbsp;</td>
                                                      <td><textarea name="address" rows="3" cols="50">Почтовый адрес</textarea>
                             <div class="registrationComment">Укажите почтовый индекс, название улицы, номер дома, квартиры
                             <br> Данная информация необходима для отправки Вам оригинала сертификата.</div>
                                                                        </br>
                                                                        </td>
                                                                </tr>
                                                                ...
                                                                <tr valign="top">
                                                                    ...
                                                                    <td  align="right"><b class="regZvesd">*</b>&nbsp;</td>
                                                                    <td>
                                                                    <textarea  name="userPlaceWorking" rows="3" cols="50">Место работы</textarea></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Должность</td>
                                                                    <td  align=right><b class="regZvesd">*</b>&nbsp;</td><td><input type="text" name="status" value="Должность" size="50" maxlength="50"/></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>День рождения</td>
                                                                ...
                                                                <tr>
                                                                    <td>E-mail</td>
                                                                    <td  align=right><b class="regZvesd">*</b>&nbsp;</td><td><input type="text" name="email" value="sanzhar73@mail.ru" size="20"   maxlength="30" id="email" /></td>

                                                                </tr>
                                                                <tr>
 <td>Контактный телефон
 </td>
 <td align=right><b class="regZvesd"></b>&nbsp;</td><td><input type="text" name="phone" value="phone" size="20" maxlength="30"/><br>&nbsp;</td>
 </tr>
                                                                <tr><?php  $numb  = mt_rand(1000000, 1000000000); ?>
                                                                    <td valign="top">Логин</td>
                                                                    <td  align=right valign="top"><b class="regZvesd">*</b>&nbsp;</td><td><input type="text" name="login" value="<?php echo $numb; ?>" size="20"  maxlength="20"/><br>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td  align="right"  valign="top"><b class="regZvesd">*</b>&nbsp;</td><td><input type="password" name="password" value="<?php echo $numb; ?>" size="20"   maxlength="30" id="password" /><br>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td  align="right"><b class="regZvesd">*</b>&nbsp;</td><td><input type="password" name="password2" value="<?php echo $numb; ?>" size="20"   maxlength="30" id="password2" /></td>
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>Введите код:</td>
                                                                        <td><input type="text" name="sec_code" id="sec_code" style="width:115px" value="<?php echo $number;  ?>"/></td>
                                                                    </tr>
                                                                </table>
