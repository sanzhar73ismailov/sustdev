...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <tr  valign="top">
                             ...
                             <div class="registrationComment">Укажите <strong>почтовый индекс</strong>, название улицы, номер дома, квартиры
                             <br> Данная информация необходима для отправки Вам оригинала сертификата.</div>
                                                                ...
                                                                <tr valign="top">
                                                                    ...
                                                                    <td  align="right"><b class="regZvesd">*</b>&nbsp;</td>
                                                                    <td>
                                                                    <textarea  name="userPlaceWorking" rows="3" cols="50"></textarea></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Должность</td>
 ...
 <td align=right><b class="regZvesd"></b>&nbsp;</td><td><input type="text" name="phone" value="" size="20" maxlength="30"/><br>&nbsp;</td>
 </tr>
                                                                <tr>
                                                                    ...
                                                                    <td  align=right valign="top"><b class="regZvesd">*</b>&nbsp;</td><td><input type="text" name="login" value="" size="20"  maxlength="20"/><br>
                                                                            <div class="registrationComment">Логин - это уникальное короткое имя, необходимое для входа на сайт. Комбинация логина и пароля являются пропуском к Вашему профилю.<span class="cell_green">В логине нельзя использовать кириллицу</span>.</div>
                                                                      </br></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <table>
                                                                    <tr><? $number = insertCodeImage(); ?>
                                                                        ...
                                                                        <td><img src ="code.png" width="70" height="50" alt="Включите эту картинку для отображения кода безопасности" border="0" alt="" />
                                                                            <a href="javascript:window.location.reload();">обновить если не виден код <br>(если работаете в Operе нажмите F5)</a></td>
